...
- 💻 Java-focused developer (Desktop + Android)
- 🔗 Experienced with REST APIs & database integration
- 🧠 Strong analytical and problem-solving mindset
- 🏗️ I enjoy building software that solves real business problems
- 📚 Currently learning backend architecture & scalable design
...
🔹 **Helios Extension App**  
Internal business desktop app with DB design, API integration & email client.

🔹 **Android Order Management App**  
Java Android app using REST APIs, RecyclerView & fragments.

🔹 **Strava Analytics Tool**  
Sports analytics desktop app using Strava API & data visualization.
